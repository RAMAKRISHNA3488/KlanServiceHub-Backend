...
CREATE TABLE IF NOT EXISTS permissions (
  ...
  name TEXT NOT NULL,
  category TEXT NOT NULL, -- COMPANY, USER, ROLE, TEAM, PROJECT, ISSUE, BOARD, SPRINT, WORKFLOW, DASHBOARD, REPORT, AUTOMATION, NOTIFICATION, INTEGRATION, API, SECURITY, AUDIT, DATA, BILLING
  description TEXT
);
...
-- 6. Issue Types, Workflows & Sprints
...
-- 7. Tasks, Multi-Assignees, Comments & Attachments
...
-- 11. Project Governance, Decisions, Risks & Approvals
...
-- 13. Automations, Notifications & Integrations
...
-- 14. Activity, Favorites & System Auditing
